...
$(document).ready(function () {
     ...
     var formatedText = "";
      ...
      jsonObject.Countries.forEach(
        function(item, index) {
         ...
         formatedText += "<div class='called-details-div'><h5>History Cases: " + item.TotalConfirmed + "<h5></div>";
         formatedText += "<div class='called-details-div'><h5>Recent Deaths: " + item.NewDeaths + "<h5></div>";
         formatedText += "<div class='called-details-div'><h5>New Confirmed Cases: " + item.NewConfirmed + "<h5></div>";
         formatedText += "<div class='called-details-div'><h5>Recent Recovers: " + item.NewRecovered + "<h5></div>";
         flag=1;
          return;
        }
      }
  ...
  function setNotFoundMessages() {
    $("#search-results-heading").text("That's not fun. Please enter a correct country name e.g. India");
    $("#results").text("");
  }
//Currency Converter
  $(document).ready(function () {
